package com.springboot.collections.queue;
...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
		...
		qlist.add(19);
		qlist.add(8);
		System.out.println("Queue elements: "+qlist);
		...
		System.out.println("All elements matches Even numbers: "+qlist.stream().allMatch( n ->n%2==0));
		
		System.out.println("All elements matches odd numbers: "+qlist.stream().allMatch(n -> n%2!=0));
		
		System.out.println("Any element matches odd number: "+qlist.stream().anyMatch(n ->n%2!=0));
		
		System.out.println("Any element matches even number: "+qlist.stream().anyMatch(n ->n%2==0));
